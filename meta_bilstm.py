...
# Evaluate meta-model
all_metrics_train.append(evaluate_model(meta_model, stacked_train, y_train, 'Meta_BiLSTM_train'))
all_metrics_test.append(evaluate_model(meta_model, stacked_test, y_test, 'Meta_BiLSTM_test'))
...
# Save all metrics
all_metrics_train_df.to_csv(os.path.join(base_dir, 'rerun_BiLSTM_stacked_model_train_metrics.csv'))
all_metrics_test_df.to_csv(os.path.join(base_dir, 'rerun_BiLSTM_stacked_model_test_metrics.csv'))
